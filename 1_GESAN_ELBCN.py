...
def validate(AUC_get, epoch, running_loss_max):
    ...
    if AUC_get < AUC:
        ...
        torch.save(model_classify.state_dict(), 'ELBCN_Best.pth')
        torch.save(model.state_dict(), 'GESAN_Best.pth')
        print("saved~~~~~~")
...
######Build the model
    ...
    model.load_state_dict(torch.load("GESAN_Best_level1.pth"))
    ...
    optimizer_FLCN = optim.AdamW(model_classify.parameters(), lr=lr2)  # #
